...
- `docs/capability-registry-plan.md` — registry component plan (R1 complete; R2 in progress — publish-time governance checks, invoke node, and run metrics → `evaluation` scores shipped).
